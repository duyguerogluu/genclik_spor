...
class TrainingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final pastTrainings = [
      {'date': '12 Mart 2025', 'branch': 'Basketbol', 'gym': 'Nevin Yanıt Spor Salonu', 'coach': 'Ahmet Yılmaz'},
      {'date': '15 Mart 2025', 'branch': 'Voleybol', 'gym': 'Adnan Menderes Spor Kompleksi', 'coach': 'Mehmet Demir'},
    ];

    final upcomingTrainings = [
      {'date': '22 Mart 2025', 'branch': 'Yüzme', 'gym': 'Olimpik Yüzme Havuzu', 'coach': 'Fatma Kaya'},
      {'date': '25 Mart 2025', 'branch': 'Atletizm', 'gym': 'Stadyum', 'coach': 'Ali Can'},
    ];
  ...
  Widget _buildTrainingList(BuildContext context, List<Map<String, String>> trainings, {bool isPast = false}) {
      ...
      itemBuilder: (context, index) {
        ...
        return Card(
          ...
          child: ListTile(
            ...
            trailing: isPast ? const Icon(Icons.check_circle, color: Colors.green) : const Icon(Icons.access_time, color: Colors.orange),
          ),
        );
      },
    );
