...
class GymDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<String> courses = ["Basketbol Kursu", "Yüzme Kursu", "Voleybol Kursu"];
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            Text("Antrenörler", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: darkblue)),
            ...
            const SizedBox(height: 24),
            Text("Kurslar", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: darkblue)),
            const SizedBox(height: 8),
